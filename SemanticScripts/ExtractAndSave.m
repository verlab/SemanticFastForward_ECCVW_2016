...
function [Rects, total_values] = ExtractAndSave(input_filename, extractor)
    ...
    % rects = struct('row', zeros(detected_pedestrians_size,1), 'col', zeros(detected_pedestrians_size,1), ...
    % 'width', zeros(detected_pedestrians_size,1), 'height', zeros(detected_pedestrians_size,1), 'score', zeros(detected_pedestrians_size,1),...
    % 'gaussianWeight', zeros(detected_pedestrians_size,1), 'pedestrianSizeValue', zeros(detected_pedestrians_size,1));
    j = 1;
    index_aux = 1;
