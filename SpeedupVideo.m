...
% semantic_extractor -> The extractor (face, pedestrian)
%
% Other arguments (see function parser)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function SpeedupVideo(video_dir, experiment, semantic_extractor, SN, SNS, shakiness_weights, velocity_weights, appearance_weights, semantic_weights, varargin)
close all
...
validSemanticExtractor = {'none', 'face', 'pedestrian'};
